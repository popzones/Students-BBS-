...
public class Like implements Serializable {
    ...
    public Like(Integer likeId, Integer userId, Integer userLikePostId, Integer userLikeCommentId, String userLikePostUrl, String userLikePostTitle, String userLikeCommentContent, Integer userBelikedId) {
        this.likeId = likeId;
        this.userId = userId;
